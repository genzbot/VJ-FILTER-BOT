...
PICS = (environ.get('PICS', 'https://envs.sh/0R2.jpg')).split() #SAMPLE PIC
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmyripxbot:wlBeXfyzfWz99zrS@filmyripxbot.jnf9p.mongodb.net/?retryWrites=true&w=majority&appName=filmyripxbot")
